...
private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Hello Triangle", nullptr, nullptr);
    ...
    void populateDebugUtilsMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) const
    {
        createInfo = {};
    ...
    bool isDeviceSuitable(VkPhysicalDevice device)
    {
        ...
        std::cout << "Executing using: " << deviceProperties.deviceName << '\n';
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device)
    {
        ...
        std::cout << "Device has " << queueFamilyCount << " queue families available." << '\n';
    ...
    void createSurface()
    {
        ...
        {
            throw std::runtime_error("Could not create VkSurfaceKHR!");
        }
    }
    ...
    VkShaderModule createShaderModule(const std::vector<char>& code)
    {
        ...
        {
            throw std::runtime_error("Could not create VkShaderModule!");
        }
    ...
    void createFramebuffers()
    {
        ...
        for (size_t i = 0; i < swapChainImageViews.size(); i++)
        {
            ...
            {
                throw std::runtime_error("Could not create VkFramebuffer!");
            }
        }
    }
    ...
    void createCommandPool()
    {
        ...
        {
            throw std::runtime_error("Could not create VkCommandPool!");
        }
    }
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        {
            throw std::runtime_error("Could not begin VkCommandBuffer!");
        }
    ...
    void createCommandBuffers()
    {
        ...
        {
            throw std::runtime_error("Could not allocate VkCommandBuffer(s)!");
        }
    }
    ...
    void mainLoop()
    {
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            {
                glfwSetWindowTitle(window, (std::string("FPS: ") + std::to_string(frameCount)).c_str());
                frameCount = 0;
